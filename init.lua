...
do
  ...
  vim.api.nvim_create_autocmd("FileType", {
    ...
    callback = function()
      ...
      vim.keymap.set("n", "<leader>.", "i---<CR>---<Esc>Otitle: \"\"<CR>author: \"\"<CR>date: \"\"<CR>mainfont: \"Adwaita Sans\"<CR>monofont: \"ComicShannsMono Nerd Font\"<CR>fontsize: 12pt<Esc>jo<CR>", { buffer = true })
  ...
  vim.api.nvim_create_autocmd("FileType", {
    ...
    callback = function()
      ...
      vim.keymap.set("n", "<leader>m", "i#let date = datetime()<Esc>i<CR><Esc>O<Tab>year: 0000,<CR>month: 0,<CR>day: 00,<Esc>jo<Cr>#set text()<Esc>ifont: \"\"<Esc>iAdwaita Sans<Esc>o<CR>#date.display()<CR><CR>= Example Header<CR><CR>== Example Subheader<Esc>=ggG", { buffer = true })
